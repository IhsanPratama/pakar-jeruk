				...
				<div style="margin-top:10px">
					...
					<div class="span3">
						<div class="row text-error" style="margin-left:20px; margin-right:auto; margin-top:15px; margin-bottom:15px;">
							<div>
								<span class="icon-map-marker"></span> Jl. Siliwangi No. 24 Kota Tasikmalaya 46115 Jawa Barat
							</div>
							<div>
								<span class="icon-envelope"></span> <a href="mailto:#">unsil@gmail.com</a>
							</div>
							<div>
								<span class="icon-bell"></span> (0265) 330634
							</div>
						</div>
					</div>
					<div class="span3">
